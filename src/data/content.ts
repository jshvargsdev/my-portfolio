...
export const hero = {
  kicker: {
    es: 'Full Stack Developer · Caracas, VE',
    en: 'Full Stack Developer · Caracas, VE',
  } as Bi,
...
export const about = {
  ...
  education: {
    ...
    school: {
      es: 'Instituto Universitario Jesús Obrero',
      en: 'Instituto Universitario Jesús Obrero',
    } as Bi,
    year: '2026',
  },
  ...
  jobs: [
    {
      ...
      desc: {
        es: 'Desarrollo y optimizo la arquitectura del servidor y bases de datos, colaborando en el frontend para entregar soluciones integrales.',
        en: 'I develop and optimize server and database architecture, collaborating on the front end to deliver comprehensive solutions.',
      },
      tags: [
        'React.js',
        'Node.js',
